...
class TestIHA(TestCase):
    ...
    def test_mean_month(self):
        ...
        lower_line, upper_line = self.iha_obj.rva_line(data_group=data_group, boundaries=17)
    ...
    def test_pulse(self):
        data_group, data2, threshold_high, threshold_low = self.iha_obj.frequency_and_duration(
            type_criterion=None, type_threshold="stationary", duration=0, threshold_high=4813, threshold_low=569.5)
